/* newuoa.f -- translated by f2c (version 20160102).
	...
	double *d__, double *vlag, double *w)
{
    ...
    static cilist io___154 = { 0, 6, 0, fmt_500, 0 };
    static cilist io___155 = { 0, 6, 0, fmt_510, 0 };
    static cilist io___156 = { 0, 6, 0, fmt_520, 0 };
    static cilist io___157 = { 0, 6, 0, fmt_550, 0 };
    static cilist io___158 = { 0, 6, 0, fmt_520, 0 };
	...
	maxfun, double *w)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___223 = { 0, 6, 0, fmt_10, 0 };
