...
extern "C" {
  ...
  void daall_(int &, const int &, const char [], const int &, const int &);
  ...
  void datra_(const int &, const int &, int &);
  ...
  void jbabs_(const int &, double &);
  void dapek_(const int &, const int [], double &);
  void dapok_(int &, const int [], const double &);
  void dapri77_(const int &, const int &);
  void darea77_(const int &, const int &);
